(() => {
    var action = new PlugIn.Action(function(selection, sender){
    	...
    	try {
			...
			var childTag = parentTag.children.byName("waiting")
			if(!childTag){
				var errMessage = "There is no “Waiting” tag. Please select “Display Board” from the “Kanban Board” sub-menu in the Automation menu to add the missing tag."
				throw new Error(errMessage)
			}
